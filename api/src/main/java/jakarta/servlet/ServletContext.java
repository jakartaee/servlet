...
public interface ServletContext {
     ...
     *
     * <p>
     * Some containers may allow writing to the Path returned by this method using the methods of the File class.
     *
     * <p>
     * The resource content is returned directly, so be aware that requesting a <code>.jsp</code> page returns the JSP
     * source code. Use a <code>RequestDispatcher</code> instead to include results of an execution.
    ...
    public enum PathCodingMode {
         ...
         *
         * <p>
         * If request contains a path with encoded reserve characters is received, then the request will be rejected by the
         * servlet container with a 400 BAD REQUEST response.
         */
        DECODED,
