 ...
 * file, or Jakarta Server Pages file) on the server. The servlet container creates the <code>RequestDispatcher</code>
...
public interface RequestDispatcher {
    ...
    /**
     * Forwards a request from a servlet to another resource (servlet, Jakarta Server Pages file, or HTML file) on the
     * server. This method allows one servlet to do preliminary processing of a request and another resource to generate the
     * response.
     *
     * <p>
    ...
    /**
     * Includes the content of a resource (servlet, Jakarta Server Pages page, HTML file) in the response. In essence, this
