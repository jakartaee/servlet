...
The `HttpServlet` class define the `isSensitiveHeader` method which
identifies sensitive headers that should not appear on `TRACE` operation.
This implementation can be used to hide headers in a response.
