...
Document the risks created by a filter modifying the `ServletResponse` and add
a recommendation that filters that do should endeavour to minimise the risk of
any breakage.
