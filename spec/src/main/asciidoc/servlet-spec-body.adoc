...
as `Servlet/{spec-version}`. Optionally, the supplementary information of the
...
Here’s the examples of this header.
 ...
 X-Powered-By: Servlet/{spec-version}

 X-Powered-By: Servlet/{spec-version} JSP/3.0 (GlassFish Server 6.0 Java/Oracle Corporation/1.8)
