...
link:https://github.com/jakartaee/servlet/issues/21[Issue 21]::
Add a new method, `HttpServletRequest.authenticate()` that can be used to
trigger authentication using the credentials, if any, present in the request
without any futher user interaction.
