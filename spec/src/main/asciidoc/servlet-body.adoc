:sectnums:
= Jakarta Servlet Specification, Version 4.0
...
The Java Servlet API v.4.0 is a required API
of the Java Platform, Enterprise Edition, 8link:#a3521[2].
...
Unless explicitly excluded, Servlet 4.0
...
X-Powered-By: Servlet/4.0 JSP/2.3 (GlassFish
